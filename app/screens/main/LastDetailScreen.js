  ...
  useEffect(() => {
    ...
    return(
        <ScrollView stle={{flex:1 }} >
            <View style={{height:76, backgroundColor: '#006E6D', flexDirection: 'row',}} >
            ...
            <View style={{height: 55, paddingLeft:15}}>
                    ...
                    <View >
                        <Text style={{fontSize: 20, fontWeight: '500', color:'#44474C'}}>
                            - Số hiệu : {data.codedl}
                        </Text>
                    </View>
            ...
            <View style={{flex:1, paddingHorizontal:10}}>
                    <Text style={{fontSize:18, fontWeight: '400', color:'#44474C'}}>
                        {data.ntdl}
                    </Text>
            </View>
